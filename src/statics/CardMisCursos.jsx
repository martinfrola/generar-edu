...
function CardMisCursos(props) {
  ...
  return (
    <Link to="/viewcurso" className="text-decoration-none text-dark">
      <div className="card-mis-cursos bg-secondary rounded  m-2 py-2 px-2">
        <div className="go-to-curso">
          <img
            src={ImgCurso}
            alt="imagen del curso"
            className="w-100 rounded go-img "
          />
          <img className="go-icon" src={Play} alt="play button" />
        </div>

        <h3 className="text-text fw-bold pt-2">Modulo uno super cheto</h3>
        <p className="text- text">
          Descripción copada de un curso que la rompe
        </p>
        <Link to="/viewcurso" className="hide btn-go-curso">
